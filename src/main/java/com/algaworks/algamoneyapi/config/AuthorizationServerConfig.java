...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
		...
		clients.inMemory()
				...
				.and()
					...
					.scopes("read")
					.authorizedGrantTypes("password", "refresh_token") 
					.accessTokenValiditySeconds(20) // tempo de duração do token
					.refreshTokenValiditySeconds(3600 * 24); // tempo de duração refresh token 1 dia.
	}	// Com o refresh token, podemos ficar pegando um novo access token novo sempre que um expirar

	
	@Override	// Definimos como vai ser o armazenamento do token,o tipo customizado de tokenEnhacer e quem vai gerencia-los
	...
	@Bean	// Definimos o access converter que é usado no  método configure, e passamos a "key" que é "algaworks"
...
@Bean // supri as informações adicionais do access token
